...
use crate::{context::Context, errors::Result, requests::workflow::BindWalletAddressRequest};
...
#[utoipa::path(
    ...
    request_body(
        content = inline(BindWalletAddressRequest),
...
pub async fn bind(
    ...
    Path(_id): Path<Uuid>,
    Json(_req): Json<BindWalletAddressRequest>,
